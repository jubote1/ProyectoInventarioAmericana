...
public class Insumo {
	...
	public int getIdCategoriaDespacho() {
		return idCategoriaDespacho;
	}
	public void setIdCategoriaDespacho(int idCategoriaDespacho) {
		this.idCategoriaDespacho = idCategoriaDespacho;
	}
