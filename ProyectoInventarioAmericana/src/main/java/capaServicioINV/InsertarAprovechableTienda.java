 ...
 */
@WebServlet("/InsertarAprovechableTienda")
/**
 * Servlet que tiene como objetivo la INserci�n del encabezado de un despacho tienda.
 * @author JuanDavid
 *
 */
public class InsertarAprovechableTienda extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public InsertarAprovechableTienda() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        DesechoTienda des = new DesechoTienda(0,0, idtienda, fecha, descripcion, motivo, idDesecho, gramos, cantidad, usuario);
        String respuesta = inv.insertarDesechoTiendaV2(des);
