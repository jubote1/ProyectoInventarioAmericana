 ...
 */
@WebServlet("/ExisteDespachoTiendaFecha")
public class ExisteDespachoTiendaFecha extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public ExisteDespachoTiendaFecha() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        String respuesta = inv.verificarExistenciaDespachoTienda(idtienda, fechasurtir);
