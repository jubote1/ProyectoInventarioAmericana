 ...
 */
@WebServlet("/ObtenerDesechosTiendaFechas")
/**
 * Servlet que tiene como objetivo la INserci�n del encabezado de un despacho tienda.
 * @author JuanDavid
 *
 */
public class ObtenerDesechosTiendaFechas extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public ObtenerDesechosTiendaFechas() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        String respuesta = inv.obtenerDesechosTiendaFechasServicio(fechaInicial, fechaFinal, idtienda);
