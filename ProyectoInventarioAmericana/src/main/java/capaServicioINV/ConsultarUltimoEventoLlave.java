 ...
 */
@WebServlet("/ConsultarUltimoEventoLlave")
public class ConsultarUltimoEventoLlave extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public ConsultarUltimoEventoLlave() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        String respuesta = inv.consultarUltimoEventoLlave(idLlave);
