 ...
 */
@WebServlet("/ValidarExistenciaNumeroDesecho")
public class ValidarExistenciaNumeroDesecho extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public ValidarExistenciaNumeroDesecho() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        String respuesta = inv.validarExistenciaNumeroDesecho(numeroDesecho);
