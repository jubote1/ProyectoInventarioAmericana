 ...
 */
@WebServlet("/CalcularInventarioTiendaSinFecha")
public class CalcularInventarioTiendaSinFecha extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public CalcularInventarioTiendaSinFecha() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        String respuesta = inv.CalcularInventarioTiendaSinFecha(idtienda, fechaSurtir);
