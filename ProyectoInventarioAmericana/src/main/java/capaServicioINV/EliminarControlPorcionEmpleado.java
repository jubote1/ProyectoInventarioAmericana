 ...
 */
@WebServlet("/EliminarControlPorcionEmpleado")
/**
 * Servlet que tiene como objetivo la INserción del encabezado de un despacho tienda.
 * @author JuanDavid
 *
 */
public class EliminarControlPorcionEmpleado extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public EliminarControlPorcionEmpleado() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        String respuesta = tiendaCtrl.eliminarControlPorcionEmpleado(idUsuario, idTienda, idPedido, idDetallePedido, fecha);
